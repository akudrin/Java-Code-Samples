...
class Inventory
{
    ...
    public static void main(String[] args)
    {
        List<Part> parts = Arrays.asList(
                ...
                new Part("brakes","Acme",3,new Item("AC25",1,90.74),
        ...
        Supplier<Integer> selectTimeLimit = () ->
                Integer.parseInt((new Scanner(System.in)).nextLine());System.out.println(
        ...
        while (!done)
        {
            switch (selectOperation.get())
            {
                ...
                case 2:
                    System.out.print("Select a part name:");
                    partName = selectPartName.get();
                    parts.stream().filter(x -> x.name.equals(partName))
                            .flatMap(x -> x.models.stream())
