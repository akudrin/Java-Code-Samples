public class BulbTest {
    public static void main(String[] args) {
        /*
         * Uncomment only one of the following statements at a time. Observe the output
         * to see the difference in the way the Bulb class is loaded and initialized.
         */
