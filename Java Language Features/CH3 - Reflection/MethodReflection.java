...
public class MethodReflection {
    public static void main(String[] args) {
        ...
        /*
         * Uncomment the following code to print all methods in the Person class // Get
         * the accessible public methods methodsDescription = getMethodsList(c);
         * System.out.println("\nMethods for " + c.getName()); for (String desc :
         * methodsDescription) { System.out.println(desc); }
         */
    }
