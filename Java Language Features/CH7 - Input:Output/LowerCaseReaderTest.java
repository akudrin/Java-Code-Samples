...
public class LowerCaseReaderTest {
    public static void main(String[] args) {
        ...
        try (LowerCaseReader lcr = new LowerCaseReader(new FileReader(fileName))) {
        ...
        try (BufferedReader br = new BufferedReader(new LowerCaseReader(new FileReader(fileName)))) {
