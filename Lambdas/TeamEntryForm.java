...
public class TeamEntryForm extends Application {
    ...
    public static final ObservableList positions
    ...
    /**
     * Utility method for creating a Player and adding the Player to the team
     * List.
     *
     * @param first
     * @param last
     ...
     * @param status
     */
    private void createPlayer(String first,
            String last,
            int goals,
            String position,
            int status) {
    ...
    public void start(Stage primaryStage) {
        ...
        positions.addAll(
                GOALIE, CENTER, DEFENSE, LEFTWING, RIGHTWING
        );
